...
class InhertitAccountChartTemplate(models.Model):
    ...
    def _load(self, sale_tax_rate, purchase_tax_rate, company):
        ...
        if not company.account_journal_suspense_account_id:
            ...
            print('company.code_digits   1  : ',self.code_digits)
        ...
        if not company.account_journal_payment_credit_account_id:
            ...
            print('company.account_journal_payment_credit_account_id',company.account_journal_payment_credit_account_id)
            print('company.code_digits',self.code_digits)

        company.account_journal_payment_debit_account_id = company.account_journal_payment_credit_account_id.id
