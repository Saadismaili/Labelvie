""" init py report account.report.details.cpc """
...
class AccountReportDetailsCPC(models.AbstractModel):
    """ init py report account.report.details.cpc """
    _name = "account.report.details.cpc"
    _description = "account.report.details.cpc"
    _inherit = "account.report.esg.tfr"
    _group_model = 'details.cpc.group'
