...
class AccountInvoiceLine(models.Model):
    ...
    asset_category_id = fields.Many2one('account.asset.category', string='Categorie d\'immobilisation')
    asset_start_date = fields.Date(string='Date débit d\'immobilisation', compute='_get_asset_date', readonly=True, store=True)
    asset_end_date = fields.Date(string='Date fin d\'immobilisation', compute='_get_asset_date', readonly=True, store=True)
    asset_mrr = fields.Float(string='Revenus récurrents mensuels', compute='_get_asset_date', readonly=True, digits=dp.get_precision('Account'), store=True)
